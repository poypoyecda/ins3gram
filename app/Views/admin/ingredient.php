<div class="row">
    <div class="col-md-3">
        <div class="card">
            <?= form_open('admin/ingredient/insert') ?>
    ...
    <div class="col-md-9">
        <div class="card">
            ...
            <div class="card-body">
                <table id="ingredientTable" class="table table-sm table-hover">
                    <thead>
                    <tr>
                        <th>ID</th>
                        <th>Nom</th>
...
<div class="modal" id="modalingredient" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button onclick="saveingredient()" type="button" class="btn btn-primary">Sauvegarder</button>
            </div>
        </div>
    </div>
</div>
<script>
    ...
    const myModal = new bootstrap.Modal('#modalingredient');
    ...
    function saveingredient() {
        ...
        $.ajax({
            url: '<?= base_url('/admin/ingredient/update') ?>',
            type: 'POST',
            data: {
                name: name,
                id: id,
